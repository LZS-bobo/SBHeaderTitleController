...
- (void)viewDidLoad {
    ...
    [btn setImage:[UIImage imageNamed:@"shop_imformation"] forState:UIControlStateNormal];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"secondcell     %ld", indexPath.row];
